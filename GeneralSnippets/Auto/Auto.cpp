...
namespace Auto_Examples {
    ...
    static void test_01() {
        ...
        auto z = 123.45f ;   // Type Deduction // Typableitung
    ...
    //static auto fooSeminar(bool flag, T f, U d) -> decltype (f + d)
    //{
    //    if (flag) {
    //        return d;
    //    }
    ...
    void testSeminar()
    {
        auto result = fooSeminar (true, 123, 456);
    }
